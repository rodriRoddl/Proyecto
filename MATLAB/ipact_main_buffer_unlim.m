...
% This is a state-space model-based simulation. The ONUs are assumed to have unlimited buffer. 
...
onu_max_grant = 2500;                                       % ONU maximum grant size (Bytes)
...
R_p = 1000e6;                                               % total uplink datarate (in bps) = 1000 Mbps
R_pb = R_p/8;                                               % total uplink datarate (in Bps)
R_o = 100e6;                                                % max ONU uplink datarate (in bps) = 100 Mbps
R_ob = R_o/8;                                               % max ONU uplink datarate (in Bps)

pkt_sz_min = 64;                                            % Ethernet packet size - minimum
pkt_sz_max = 1542;                                          % Ethernet packet size - maximum
